...
xv_path="/media/lite/DATA/A_Software/Xilinx/Vivado2016.03/Vivado/2016.3"
...
{
  file="xsim.ini"
  lib_map_path="/media/lite/DATA/A_Software/Xilinx/Vivado2016.03/Vivado/2016.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
