...
HD_PWD='/media/lite/DATA/E_Dissertation/HPRTU/projects/eLinuxPrj/Prj/2-4_XADC_MultiChannels_Decimation_DMA/xadc_pynq/xadc_pynq.runs/design_1_XADC_SignalChannel_PreProcess_64_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_XADC_SignalChannel_PreProcess_64_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_XADC_SignalChannel_PreProcess_64_0_0.tcl
