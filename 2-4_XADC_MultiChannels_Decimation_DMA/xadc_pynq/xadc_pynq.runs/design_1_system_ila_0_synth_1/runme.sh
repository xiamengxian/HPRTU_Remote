...
HD_PWD='/media/lite/DATA/E_Dissertation/HPRTU_Remote/2-4_XADC_MultiChannels_Decimation_DMA/xadc_pynq/xadc_pynq.runs/design_1_system_ila_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_0.tcl
